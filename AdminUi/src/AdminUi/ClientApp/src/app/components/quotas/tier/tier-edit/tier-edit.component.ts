...
export class TierEditComponent {
  ...
  constructor(
    ...
    this.headerDescriptionCreate =
      'Please fill the form below to create your Tier';
    this.headerDescriptionEdit =
      'Perform your desired changes and save to edit your Tier';
