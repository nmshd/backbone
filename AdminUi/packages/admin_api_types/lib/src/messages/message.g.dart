...
MessageOverview _$MessageOverviewFromJson(Map<String, dynamic> json) =>
    MessageOverview(
      ...
      recipients: (json['recipients'] as List<dynamic>)
          .map(MessageRecipients.fromJson)
          .toList(),
    );

Map<String, dynamic> _$MessageOverviewToJson(MessageOverview instance) =>
    <String, dynamic>{
...
MessageRecipients _$MessageRecipientsFromJson(Map<String, dynamic> json) =>
    MessageRecipients(
      messageId: json['messageId'] as String,
      address: json['address'] as String,
    );

Map<String, dynamic> _$MessageRecipientsToJson(MessageRecipients instance) =>
    <String, dynamic>{
      'messageId': instance.messageId,
