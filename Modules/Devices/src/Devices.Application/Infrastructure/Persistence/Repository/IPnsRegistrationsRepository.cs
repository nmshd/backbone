...
public interface IPnsRegistrationsRepository
{
    ...
    Task<PnsRegistration?> Get(DeviceId deviceId, CancellationToken cancellationToken, bool track = false);
    Task<PnsRegistration[]> List(DeviceId[] deviceIds, CancellationToken cancellationToken, bool track = false);
