...
public class HandlerTests
{
    ...
    public async Task Sends_first_reminder()
    {
        ...
        // Assert
        A.CallTo(() => mockPushNotificationSender.SendNotification(identity.Address, A<DeletionProcessGracePeriodReminderPushNotification>._, A<string>._, A<CancellationToken>._))
