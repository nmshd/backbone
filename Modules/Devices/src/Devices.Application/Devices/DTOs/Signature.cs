...
public class Signature
{
    ...
    public static Signature FromBytes(byte[] bytes)
    {
        ...
        var signatureObject = JsonSerializer.Deserialize<dynamic>(signatureJsonString, new JsonSerializerOptions { Converters = { new DynamicJsonConverter() } }) ?? throw new Exception("Could not deserialize signature.");
