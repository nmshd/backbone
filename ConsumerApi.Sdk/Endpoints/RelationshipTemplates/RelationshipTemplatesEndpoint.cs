...
public class RelationshipTemplatesEndpoint(EndpointClient client) : Endpoint(client)
{
    ...
    public async Task<ApiResponse<RelationshipTemplate>> GetTemplate(string id) => await _client.Get<RelationshipTemplate>($"api/{API_VERSION}/RelationshipTemplates/{id}");
    ...
    public async Task<ApiResponse<CreateRelationshipTemplateResponse>> CreateTemplate(CreateRelationshipTemplateRequest request)
        => await _client.Post<CreateRelationshipTemplateResponse>($"api/{API_VERSION}/RelationshipTemplates", request);
}
