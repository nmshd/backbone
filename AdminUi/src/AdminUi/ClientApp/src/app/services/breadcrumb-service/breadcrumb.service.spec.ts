...
describe("BreadcrumbService", function() {
  ...
  const initialHistory = [{label: "Home", url: "/home"}, {label: "Details", url: "/details"}, {label: "Products", url: "/products"}];
  ...
  it("should return the breadcrumb history array",async function() {
    // Arrange
    const expectedHistory = [{label: "Home", url: "/home"}, {label: "Details", url: "/details"}, {label: "Products", url: "/products"}];
  ...
  it("should return a flat array when multiple trails are added", async function() {
    ...
    const secondTrail = [{ label: "Details", url: "/details" }, { label: "Products", url: "/products" }];
  ...
  it("should clear history after the specified index", async function() {
    // Arrange
    const expectedHistory = [{label: "Home", url: "/home"}, {label: "Details", url: "/details"}];
    breadcrumbService["breadcrumbHistory"] = [...initialHistory];
