...
BEGIN
   ...
   FROM pg_user
   WHERE usename = 'nmshdAdmin') THEN
   CREATE USER "nmshdAdmin"
...
BEGIN
   IF NOT EXISTS (SELECT usename
   FROM pg_user
   WHERE usename = 'synchronization') THEN
...
BEGIN
   IF NOT EXISTS (SELECT usename
   FROM pg_user
   WHERE usename = 'relationships') THEN
...
SET search_path
TO "Messages";
ALTER USER relationships
SET search_path
TO "Relationships";
ALTER USER synchronization
SET search_path
TO "Synchronization";
ALTER USER tokens
SET search_path
...
CREATE TABLE
IF NOT EXISTS "Challenges"."__EFMigrationsHistory"
(
...
ALTER TABLE
IF EXISTS "Challenges"."__EFMigrationsHistory" OWNER to challenges;

CREATE TABLE
IF NOT EXISTS "Devices"."__EFMigrationsHistory"
(
    "MigrationId" character varying
(150) COLLATE pg_catalog."default" NOT NULL,
    "ProductVersion" character varying
...
ALTER TABLE
IF EXISTS "Devices"."__EFMigrationsHistory" OWNER to devices;

CREATE TABLE
IF NOT EXISTS "Files"."__EFMigrationsHistory"
(
    "MigrationId" character varying
(150) COLLATE pg_catalog."default" NOT NULL,
    "ProductVersion" character varying
...
ALTER TABLE
IF EXISTS "Files"."__EFMigrationsHistory" OWNER to files;

CREATE TABLE
IF NOT EXISTS "Messages"."__EFMigrationsHistory"
(
    "MigrationId" character varying
(150) COLLATE pg_catalog."default" NOT NULL,
    "ProductVersion" character varying
...
ALTER TABLE
IF EXISTS "Messages"."__EFMigrationsHistory" OWNER to messages;

CREATE TABLE
IF NOT EXISTS "Relationships"."__EFMigrationsHistory"
(
    "MigrationId" character varying
(150) COLLATE pg_catalog."default" NOT NULL,
    "ProductVersion" character varying
...
ALTER TABLE
IF EXISTS "Relationships"."__EFMigrationsHistory" OWNER to relationships;

CREATE TABLE
IF NOT EXISTS "Synchronization"."__EFMigrationsHistory"
(
    "MigrationId" character varying
(150) COLLATE pg_catalog."default" NOT NULL,
    "ProductVersion" character varying
...
ALTER TABLE
IF EXISTS "Synchronization"."__EFMigrationsHistory" OWNER to synchronization;

CREATE TABLE
IF NOT EXISTS "Tokens"."__EFMigrationsHistory"
(
    "MigrationId" character varying
(150) COLLATE pg_catalog."default" NOT NULL,
    "ProductVersion" character varying
...
ALTER TABLE
IF EXISTS "Tokens"."__EFMigrationsHistory" OWNER to tokens;
