...
{
    public async Task<ConsumerApiResponse<ListDevicesResponse>> ListDevices(PaginationFilter? pagination = null)
    ...
    public async Task<ConsumerApiResponse<RegisterDeviceResponse>> RegisterDevice(RegisterDeviceRequest request)
    ...
    public async Task<ConsumerApiResponse<EmptyResponse>> ChangePassword(ChangePasswordRequest request)
