...
public class HandlerTests : AbstractTestsBase
{
    ...
    public async Task Happy_path()
    {
        ...
        // Act
        var response = await handler.Handle(new ApproveDeletionProcessCommand { DeletionProcessId = deletionProcess.Id }, CancellationToken.None);
    ...
    public async Task Throws_when_given_identity_does_not_exist()
    {
        ...
        // Act
        var acting = async () => await handler.Handle(new ApproveDeletionProcessCommand { DeletionProcessId = "some-deletion-process-id" }, CancellationToken.None);
