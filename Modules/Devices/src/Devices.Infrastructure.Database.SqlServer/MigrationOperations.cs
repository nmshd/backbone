...
namespace Backbone.Modules.Devices.Infrastructure.Database.SqlServer;
...
public static class MigrationOperations
{
    ...
    private static void AddIndex(MigrationBuilder migrationBuilder)
    {
        ...
        sqlBuilder
            .AppendLine($"CREATE UNIQUE NONCLUSTERED INDEX [{INDEX_NAME_ONLY_ONE_ACTIVE_DELETION_PROCESS}]")
