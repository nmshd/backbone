...
public class HandlerTests : AbstractTestsBase
{
    ...
    public async Task No_identities_with_a_deletion_process_waiting_for_approval_exists()
    {
        ...
        A.CallTo(() => mockIdentitiesRepository.ListAllWithDeletionProcessInStatus(A<DeletionProcessStatus>._, A<CancellationToken>._, A<bool>._))
    ...
    public async Task Sends_first_reminder()
    {
        ...
        A.CallTo(() => mockIdentitiesRepository.ListAllWithDeletionProcessInStatus(DeletionProcessStatus.WaitingForApproval, A<CancellationToken>._, A<bool>._))
