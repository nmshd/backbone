...
class ClientsEndpoint extends Endpoint {
    ...
    int? maxIdentities,
      ...
      post(
        ...
        data: {
          ...
          if (maxIdentities != null) 'maxIdentities': maxIdentities,
        },
  ...
  Future<ApiResponse<Client>> changeClientSecret(String clientId, String newSecret) => patch(
  ...
  Future<ApiResponse<Client>> updateClient(String clientId, {required String defaultTier, int? maxIdentities}) => put(
        '/api/v1/Clients/$clientId',
        data: {
          'defaultTier': defaultTier,
          if (maxIdentities != null) 'maxIdentities': maxIdentities,
