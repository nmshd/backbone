...
internal class ChallengesStepDefinitions
{
    ...
    [When(@"{word} sends a GET request to the \/Challenges\/\{id\} endpoint with a valid id {word}.Id")]
    ...
    [When(@"{word} sends a GET request to the \/Challenges\/\{id\} endpoint with {word}.Id")]
    ...
    [When(@"{word} sends a GET request to the \/Challenges\/\{id\} endpoint with {string}")]
