...
namespace AdminUi.Infrastructure.Database.Postgres.Migrations
{
    ...
    [Migration("20231010102958_AddDefaultTierNameToClientsOverview")]
    partial class AddDefaultTierNameToClientsOverview
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("AdminUi.Infrastructure.DTOs.ClientOverview", b =>
                {
                    ...
                    b.Property<string>("DefaultTierId")
                        .IsRequired()
                        .HasColumnType("text");

                    b.Property<string>("DefaultTierName")
                        .IsRequired()
                        .HasColumnType("text");
