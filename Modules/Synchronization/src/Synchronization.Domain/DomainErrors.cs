...
public static class DomainErrors
{
    public static class Datawallet
    {
        ...
        {
            return new DomainError("error.platform.datawallet.cannotDowngrade",
        ...
        {
            return new DomainError("error.platform.datawallet.datawalletVersionOfModificationTooHigh",
