...
public class Handler : IRequestHandler<ListTokensQuery, ListTokensResponse>
{
    ...
    {
        var dbPaginationResult = await _tokensRepository.FindTokensWithIdsAndAllocationFor(request.Ids, _activeIdentity, request.PaginationFilter, cancellationToken, track: false);
