...
public class RelationshipReactivationCompletedIntegrationEventHandler : IIntegrationEventHandler<RelationshipReactivationCompletedIntegrationEvent>
{
    ...
    private readonly ILogger<RelationshipReactivationCompletedIntegrationEventHandler> _logger;

    public RelationshipReactivationCompletedIntegrationEventHandler(ISynchronizationDbContext dbContext, IEventBus eventBus, ILogger<RelationshipReactivationCompletedIntegrationEventHandler> logger)
    {
