...
public static class IEnumerableExtensions
{
    ...
    {
        public void ShouldHaveCount(int count, string? customMessage = null)
        {
            var actual = enumerable.Count();
            actual.AssertAwesomely(v => v == count, actual, count, customMessage);
        }

        public void ShouldContain(IEnumerable<T> expected, string? customMessage = null)
        {
        ...
        public void ShouldContainSingle(T expected, string? customMessage = null)
        {
        ...
        public void ShouldContainSingle(Func<T, bool> expected, string? customMessage = null)
        {
        ...
        public void ShouldContainInOrder(IEnumerable<T> expected, string? customMessage = null)
        {
