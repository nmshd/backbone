...
DeletionProcessOverview _$DeletionProcessOverviewFromJson(Map<String, dynamic> json) => DeletionProcessOverview(
      ...
      approvedByDevice: json['approvedByDevice'] as Map<String, dynamic>?,
...
Map<String, dynamic> _$DeletionProcessOverviewToJson(DeletionProcessOverview instance) => <String, dynamic>{
      'id': instance.id,
...
DeletionProcessDetails _$DeletionProcessDetailsFromJson(Map<String, dynamic> json) => DeletionProcessDetails(
      id: json['id'] as String,
      auditLog: (json['auditLog'] as List<dynamic>).map(AuditLog.fromJson).toList(),
      status: json['status'] as String,
      createdAt: DateTime.parse(json['createdAt'] as String),
      approvalReminder1SentAt: json['approvalReminder1SentAt'] == null ? null : DateTime.parse(json['approvalReminder1SentAt'] as String),
      approvalReminder2SentAt: json['approvalReminder2SentAt'] == null ? null : DateTime.parse(json['approvalReminder2SentAt'] as String),
...
Map<String, dynamic> _$DeletionProcessDetailsToJson(DeletionProcessDetails instance) => <String, dynamic>{
      'id': instance.id,
