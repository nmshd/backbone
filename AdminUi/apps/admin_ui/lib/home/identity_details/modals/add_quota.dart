...
Future<void> showAddQuotaDialog({required BuildContext context, required String identityId, required VoidCallback onQuotaAdded}) async {
...
class _AddQuotaDialog extends StatefulWidget {
  ...
  const _AddQuotaDialog({required this.identityId, required this.onQuotaAdded});
