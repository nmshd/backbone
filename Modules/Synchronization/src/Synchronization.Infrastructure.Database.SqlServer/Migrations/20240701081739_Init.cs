        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Version = table.Column<int>(type: "int", unicode: false, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DatawalletVersion = table.Column<int>(type: "int", unicode: false, nullable: false),
                    Index = table.Column<long>(type: "bigint", nullable: false),
                    ...
                    Type = table.Column<int>(type: "int", nullable: false),
                    EncryptedPayload = table.Column<byte[]>(type: "varbinary(max)", nullable: true),
                    BlobReference = table.Column<string>(type: "char(32)", unicode: false, fixedLength: true, maxLength: 32, nullable: false)
                },
                constraints: table =>
                {
