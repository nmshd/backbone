...
{
    Task<DbPaginationResult<Message>> ListMessagesWithContent(IEnumerable<MessageId> ids, IdentityAddress requiredParticipant, PaginationFilter paginationFilter, CancellationToken cancellationToken,
        bool track = false);
