...
public interface ITokensRepository
{
    ...
    Task<DbPaginationResult<Token>> ListWithContent(PaginationFilter paginationFilter, Expression<Func<Token, bool>> filter, CancellationToken cancellationToken, bool track = false);
}
