...
internal class ClientsStepDefinitions : BaseStepDefinitions
{
    ...
    {
        _getClientsResponse!.ShouldBeASuccess();
        _getClientsResponse!.ContentType.ShouldStartWith("application/json");
        await _getClientsResponse.ShouldComplyWithSchema();
    }
    ...
    {
        _changeClientSecretResponse!.ShouldBeASuccess();
        _changeClientSecretResponse!.ContentType.ShouldStartWith("application/json");
        await _changeClientSecretResponse.ShouldComplyWithSchema();
    }
    ...
    {
        _updateClientResponse!.ShouldBeASuccess();
        _updateClientResponse!.ContentType.ShouldStartWith("application/json");
        await _updateClientResponse!.ShouldComplyWithSchema();
    }
    ...
    public async Task ThenTheClientInTheBackendWasUpdatedAsync()
    {
        ...
        response.ShouldBeASuccess();
        response.Result!.DefaultTier.ShouldBe(_updatedTierId);
        response.Result.MaxIdentities.ShouldBe(_updatedMaxIdentities);
    }
    ...
    public async Task ThenTheClientInTheBackendHasNullIdentitiesLimit()
    {
        ...
        response.ShouldBeASuccess();
        response.Result!.MaxIdentities.ShouldBeNull();
    }
